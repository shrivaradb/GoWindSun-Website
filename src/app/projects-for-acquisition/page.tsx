          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="pt-6 border-t border-slate-800/80 space-y-4 relative z-10">
                ...
                <Link href="/projects-for-acquisition/wind" className="block">
                  <Button variant="primary" size="lg" className="w-full bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold rounded-none py-3.5 text-xs uppercase tracking-wider">
                    <span>View Wind Projects</span>
            ...
            >
              ...
              <div className="pt-6 border-t border-slate-800/80 space-y-4 relative z-10">
                ...
                <Link href="/projects-for-acquisition/solar" className="block">
                  <Button variant="primary" size="lg" className="w-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded-none py-3.5 text-xs uppercase tracking-wider">
                    <span>View Solar Projects</span>
                    <ArrowRight className="w-4 h-4 ml-2" />
                  </Button>
                </Link>
              </div>
            ...
            >
              ...
              <div className="pt-6 border-t border-slate-800/80 space-y-4 relative z-10">
                ...
                <Link href="/projects-for-acquisition/hybrid" className="block">
                  <Button variant="primary" size="lg" className="w-full bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold rounded-none py-3.5 text-xs uppercase tracking-wider">
                    <span>View Hybrid Projects</span>
                    <ArrowRight className="w-4 h-4 ml-2" />
                  </Button>
                </Link>
              </div>
