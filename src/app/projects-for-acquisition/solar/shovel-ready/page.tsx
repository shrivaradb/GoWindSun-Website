...
import { SolarShovelReadyStatePanel } from "@/components/projects/SolarShovelReadyStatePanel";
...
export default function ShovelReadySolarProjectsPage() {
  const [selectedStateCode, setSelectedStateCode] = useState<string | null>(null);
  const activeStateCodes = Object.keys(solarShovelReadyDataset);
        ...
        <Container>
          <div className="max-w-3xl mb-10 space-y-2">
            <span className="text-xs font-mono font-bold text-amber-600 uppercase tracking-widest">
              INTERACTIVE STATE MAP — SHOVEL READY SOLAR
            </span>
            ...
            <p className="text-xs sm:text-sm text-slate-600 font-light">
              Click on an individual state on the interactive map below to load Shovel Ready Solar project records mapped by District, State, CTU/STU, and Capacity in MW.
            </p>
          </div>
