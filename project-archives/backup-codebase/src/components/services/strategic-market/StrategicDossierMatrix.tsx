...
export const StrategicDossierMatrix: React.FC = () => {
      ...
      <Container>
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-white">
            Strategic Advisory Scope & Deliverables
          </h2>
          <p className="mt-4 text-base sm:text-lg text-slate-300 font-light leading-relaxed">
            Select a strategic domain to inspect technical scopes, market mechanics, and client deliverables.
          </p>
        </div>
